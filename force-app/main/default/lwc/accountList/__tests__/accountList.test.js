...
describe('c-account-list', () => {
    ...
    describe('Wire Adapter - Data States', () => {
        it('renders accounts when data is returned', async () => {
            ...
            const accountsList = element.shadowRoot.querySelector('.slds-has-dividers_around-space');
            ...
            const firstAccountName = accountItems[0].querySelector('.slds-text-heading_small');
            expect(firstAccountName.textContent.trim()).toBe('Acme Corporation');

            const firstAccountPhone = accountItems[0].querySelector('.slds-text-body_small');
        ...
        it('renders "No accounts found" when empty data is returned', async () => {
            ...
            const noAccountsMessage = element.shadowRoot.querySelector('.slds-text-color_weak');
        ...
        it('renders error message when wire adapter returns error', async () => {
            ...
            expect(errorHeading.textContent.trim()).toBe('Error loading accounts. Please try again later.');
    ...
    describe('Conditional Rendering Logic', () => {
        it('handles accounts with missing phone and website gracefully', async () => {
            ...
            const accountName = thirdAccount.querySelector('.slds-text-heading_small');
            expect(accountName.textContent.trim()).toBe('Tech Solutions');

            // Phone and website should not be rendered when null
            const phoneElements = thirdAccount.querySelectorAll('.slds-text-body_small');
        ...
        it('renders phone when present', async () => {
            ...
            // Assert
            const phoneElement = element.shadowRoot.querySelector('.slds-text-body_small');
    ...
    describe('Component Structure', () => {
        ...
        it('applies correct CSS classes for layout', async () => {
            ...
            expect(list.classList.contains('slds-has-dividers_around-space')).toBe(true);
    ...
    describe('Edge Cases', () => {
        ...
        it('handles accounts with missing required fields', async () => {
            ...
            const secondAccountName = accountItems[1].querySelector('.slds-text-heading_small');
